...
class BenchmarkAdmin(admin.ModelAdmin):
    list_display = ('name', 'description', 'docs_url', 'owner', 'data_preparation_mlcube', 'reference_model_mlcube','data_evaluator_mlcube','dataset_list', 'model_list', 'created_at', 'modified_at')
